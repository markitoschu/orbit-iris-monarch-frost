...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-emE2J0O8.mjs");
...
var manifest = {
	"8d3cfe6ab277d3b4826cfc4c31f6948de0cca91644278a3f5772e5a529d06e7a": {
		functionName: "listResponses_createServerFn_handler",
		importer: () => import("./server-D8fkrP2l.mjs")
	},
	"fbc51cc29b21ba506427eaf95ca37adc7f9a72b27a2b1db192f4df9de0b56069": {
		functionName: "submitResponse_createServerFn_handler",
		importer: () => import("./server-D8fkrP2l.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-5zMwHII3.mjs").then((n) => n.t),
